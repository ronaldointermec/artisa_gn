...
import re
import email.utils
import vocollect_python.email.generator
import base64
from vocollect_python import hmac
...
class SMTP:
    ...
    def send_message(self, msg, from_addr=None, to_addrs=None,
        ...
        with io.BytesIO() as bytesmsg:
            # CORRECTING A MISTAKE IN the 1.0.0 release. It was not detected at
            # the time of release that email.generator.BytesGenerator was not
            # available in Python 3.1, so this call should have been to the
            # 3.2 version of email.generator under vocollect_python.
            # 
            g = vocollect_python.email.generator.BytesGenerator(bytesmsg)
